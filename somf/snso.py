...
class X2CHelperBase(lib.StreamObject):
    ...
    def get_hcore(self, mol=None):
        ...
        if self.boettger == True:
            ...
            factor_list = [
                    [0.0,2.  ,10.  ,28.  ,60.,110.],
                    [0.0,2.32,10.64,28.38,60.,110.],
                    [0.0,2.97,11.93,29.84,64.,115.],
                    [0.0,2.97,11.93,29.84,64.,115.],
                    [0.0,2.80,11.93,29.84,64.,115.],
                    [0.0,2.95,11.93,29.84,64.,115.],
                    [0.0,3.09,11.49,29.84,64.,115.],
                    [0.0,3.02,11.91,29.84,64.,115.],
                    [0.0,2.85,12.31,30.61,64.,115.],
                    [0.0,2.85,12.31,30.61,64.,115.]]
            factor_id = self.scaled
            for ia in range(xmol.natm):
                print(factor_list[factor_id])
